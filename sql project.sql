-- create five table
-- 1. user(user id,name, email, ph.no,address)
-- 2. product(product id,name, categry, prize,product quntity)
-- 3. orders(order id,user id,order date)
-- 4. order details(order detail id,order id,product id,quntity ,prize,total amount)
-- 5. pyment(pyment id,order id,pyment date,pyment mode,amount)

-- q1. insert data minimun 20 rows
